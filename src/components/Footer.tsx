...
// Facebook's official mark is a solid disc — filled, it reads as a much
// heavier blob than Instagram's and X's brand glyphs, which are both
// inherently thin line-art shapes even in their "solid" form. Drawn as
// a thin ring with just the f-mark filled, it matches that same light
// visual weight instead of dominating next to them.
function FacebookIcon() {
  return (
    <svg width="27" height="27" viewBox="0 0 24 24" aria-hidden="true">
      ...
      <path
        fill="currentColor"
        d="M14.3 8.3h-1.1c-1.05 0-1.6.62-1.6 1.7v1.55H9.9v1.9h1.7v5.15h2.05v-5.15h1.65l.3-1.9h-1.95V10.2c0-.32.16-.5.5-.5h1.15z"
      />
    </svg>
  );
}
